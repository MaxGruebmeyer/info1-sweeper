...
We included [it](https://github.com/ThrowTheSwitch/Unity) as a [submodule](https://git-scm.com/book/en/v2/Git-Tools-Submodules),
just load it via `git submodule update --init` and you're good to go.
